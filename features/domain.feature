Feature: Domain Context
  ...
  Scenario: there are three categories of pilot licenses
    Then these licenses exist
      | class | description |
      | 1  | 1st class, commercial airline pilots |
      | 2  | 2nd class, other commercial pilots |
      | 3  | 3rd class, recreational pilots |